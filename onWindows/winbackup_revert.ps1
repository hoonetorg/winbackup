...
Write-Host "[INFO] Step 2: Expand partition to max size" -ForegroundColor Green
...
Write-Host "[INFO] Step 3: Disable fast startup/enable hibernation and enable pagefile" -ForegroundColor Green
...
Write-Host "[INFO] Step 4: Enable prefetch and superfetch (SysMain)" -ForegroundColor Green
